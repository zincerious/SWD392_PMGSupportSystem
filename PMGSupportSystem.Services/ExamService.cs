...
namespace PMGSupportSystem.Services
{
    public interface IExamService
    {
        ...
        Task<bool> ConfirmPublicationAsync(Guid examId, Guid confirmedBy, string note);
    }
    public class ExamService : IExamService
    {
        ...
        public async Task<bool> ConfirmPublicationAsync(Guid examId, Guid confirmedBy, string note)
        {
            var exams = await _unitOfWork.ExamRepository
                .GetAllAsync(
                    filter: e => e.ExamId == examId,
                    includeProperties: "Submissions"
                );
