...
namespace PMGSupportSystem.Controllers
{
    ...
    public class ExamController : ControllerBase
    {
        ...
        [Authorize(Roles = "DepartmentLeader")]
        [HttpPut("{examId}/confirm-publication")]
        public async Task<IActionResult> ConfirmPublication(Guid examId, [FromBody] ConfirmPublicationRequest request)
        {
            var success = await _servicesProvider.ExamService.ConfirmPublicationAsync(examId, request.ConfirmedBy, request.Note);
            if (!success)
